...
//                         Não foi possível exibir a página dentro do iframe — pode ser bloqueio por cabeçalhos de segurança (X-Frame-Options / Content-Security-Policy).
//                     </div>

//                     {useFallback ? (
//                         <div>
//                             <div style={{ marginBottom: 8 }}>Tentando exibir o conteúdo via API (fallback)…</div>
//                             {checking && <div>Buscando dados...</div>}
//                             {fallbackError && <div style={{ color: 'red' }}>Erro no fallback: {fallbackError}</div>}
//                             {items && (
//                                 <div>
...
//                             {!items && !checking && !fallbackError && (
//                                 <div>Configurações insuficientes para fallback. Passe listTitle, filterField e filterValue para ativar o fallback.</div>
//                             )}
//                         </div>
//                     ) : (
//                         <div>Iframe bloqueado e fallback desativado.</div>
//                     )}
//                 </div>
//             )}
//         </div>
